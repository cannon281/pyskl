model = dict(
    ...
    backbone=dict(
        ...
        gcn_with_res=True,
        tcn_type='mstcn',
        graph_cfg=dict(layout='coco', mode='spatial')),  # Keep coco layout for H36M->COCO mapping
    cls_head=dict(type='GCNHead', num_classes=15, in_channels=256))

dataset_type = 'PoseDataset'
ann_file = 'Pkl/aic_normal_dataset_with_3d.pkl'
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn++/safer_activity_xsub/non-wheelchair-3d'